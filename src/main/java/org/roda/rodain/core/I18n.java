...
public class I18n {
   ...
   * @param key The key of the required localized message
  ...
  /**
   * Gets the localized message for the key parameter using the parametrized locale.
   * @param key The key of the required localized message
   * @param languageTag The language of the message.
   * @return The localized message
   */
  ...
  /**
   * Gets the localized help message for the key parameter using the selected locale.
   * @param key The key of the required help message
